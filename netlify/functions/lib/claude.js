...
//
// SETUP RICHIESTO: su Netlify, Site settings → Environment variables → aggiungi
...
async function claudeJSON({ system, prompt, maxTokens = 1500 }) {
  ...
  if (!apiKey) throw new Error('ANTHROPIC_API_KEY non configurata nelle Environment Variables di Netlify');
