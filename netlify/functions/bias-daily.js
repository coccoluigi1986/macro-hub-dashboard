// netlify/functions/bias-daily.js
//
// Lettura del bias giornaliero geopolitico-macro (RISK-ON / RISK-OFF / NEUTRALE),
// generata da Claude a partire dalle notizie reali più recenti. Porting del prompt/schema
// JSON di backend/routers/intel.py::bias_daily() nel progetto di riferimento macrohub3.
//
...
//
// Raggiungibile su: https://tuosito.netlify.app/.netlify/functions/bias-daily
...
exports.handler = async function (event) {
  try {
    ...
    return {
      statusCode: 200,
      headers: { 'Content-Type': 'application/json', 'Cache-Control': 'public, max-age=10800' }, // 3h, come il ciclo del riferimento
